...
function [EEG com] = pop_ImportERPscoreFormat(FileName, FilePath);
...
EEG = ImportERPscoreFormat(EEG, FileName, FilePath);


% return the string command
% -------------------------

com = sprintf('EEG = pop_ImportERPscoreFormat(''%s'', ''%s'' );', FileName, FilePath);
